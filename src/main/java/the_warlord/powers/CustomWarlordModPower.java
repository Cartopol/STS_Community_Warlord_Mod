...
public abstract class CustomWarlordModPower extends AbstractPower implements CloneablePowerInterface, CustomStackBehaviorPower {
    ...
    public CustomWarlordModPower(StaticPowerInfo staticPowerInfo) {
        super();
    ...
    public void stackPower(AbstractPower otherPower) {
        ...
        if (this.amount2 != -1 || this.canGoNegative2 && otherPower instanceof CustomWarlordModPower) {
            this.fontScale = 8.0F;
            this.amount2 += ((CustomWarlordModPower) otherPower).amount2;
        }
    }
