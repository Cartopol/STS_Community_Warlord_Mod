...
public class TripleSlashCopy extends CustomWarlordModCard {

    public static final String ID = WarlordMod.makeID(TripleSlashCopy.class.getSimpleName());
