...
public abstract class CustomWarlordModCard extends CustomCard {
    ...
    private static String imgFromId(String id) {
        ...
        return WarlordMod.makeCardPath(String.format("generated/%1$s.png", unprefixedId));
    }

    public CustomWarlordModCard(final String id,
                                final int cost,
                                final CardType type,
    ...
    private CustomWarlordModCard(final String id,
